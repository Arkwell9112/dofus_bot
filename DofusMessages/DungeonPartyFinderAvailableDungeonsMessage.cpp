...
void DungeonPartyFinderAvailableDungeonsMessage::deserialize(CustomDataInput *input) {
...
void DungeonPartyFinderAvailableDungeonsMessage::_dungeonIdsFunc(CustomDataInput *input) {
