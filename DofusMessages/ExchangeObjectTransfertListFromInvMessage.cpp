...
void ExchangeObjectTransfertListFromInvMessage::deserialize(CustomDataInput *input) {
...
void ExchangeObjectTransfertListFromInvMessage::_idsFunc(CustomDataInput *input) {
