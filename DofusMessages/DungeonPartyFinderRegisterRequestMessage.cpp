...
void DungeonPartyFinderRegisterRequestMessage::deserialize(CustomDataInput *input) {
...
void DungeonPartyFinderRegisterRequestMessage::_dungeonIdsFunc(CustomDataInput *input) {
